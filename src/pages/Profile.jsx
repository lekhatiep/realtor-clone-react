    ...
    <>
      <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6'>
          ...
          font-medium rounded shadow-md hover:bg-blue-700 transition duration-150 ease-out hover:shadow-lg
          active:bg-blue-800'>
            <Link to="/create-listing" className='flex justify-center items-center'>
              <FcHome className='mr-3 text-3xl bg-red-200 rounded-full p-1 border-2'/>
